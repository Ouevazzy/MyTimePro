            ...
            VStack(spacing: 0) {
                ...
                LazyVGrid(columns: [
                    ...
                    StatCard(
                        icon: "clock.fill",
                        iconColor: .blue,
                        value: WorkTimeCalculations.formattedTimeInterval(yearlyStats.totalHours * 3600).replacingOccurrences(of: "h", with: "h"),
                        title: "Total heures"
                    )
                    StatCard(
                        icon: "clock.badge.exclamationmark.fill",
                        iconColor: yearlyStats.overtimeSeconds >= 0 ? .green : .red,
                        value: WorkTimeCalculations.formattedTimeInterval(Double(yearlyStats.overtimeSeconds)).replacingOccurrences(of: "h", with: "h"),
                        title: "Heures supp."
                    )
                    StatCard(
